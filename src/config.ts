...
class Config {
	...
	get contextMenuActionsVisibility(): ContextMenuActionsVisibility {
		...
		const config: ContextMenuActionsVisibility = {
			...
			commit: { addTag: true, createBranch: true, checkout: true, cherrypick: true, revert: true, drop: true, merge: true, rebase: true, reset: true, copyHash: true, copySubject: true, editMessage: true },
